...
* Analysis Services block just doesn't work - no checkmarks
* SCD2 isn't checked - no idea if it actually works yet
* the agent amount is weird but idk if this is ok or not
